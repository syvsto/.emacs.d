...
#+begin_src emacs-lisp
  (use-package smartparens
    ...
    :hook ((rjsx-mode . smartparens-mode)
	   (rust-mode . smartparens-mode)
	   (haskell-mode . smartparens-mode)
	   (agda2-mode . smartparens-mode)
	   (python-mode . smartparens-mode))
    :init
    (sp-use-paredit-bindings))
#+end_src

However, for Lisp, Paredit correctly handles edge cases that Smartparens
struggles with (e.g. character literals).
